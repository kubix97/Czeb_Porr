...
double GaussJordan::GaussJordanAlgotithm(Matrix &A, Vector &x, Vector &b)
{
	float alfa;
	int i = 0, j = 0, k = 0;
...
double GaussJordan::GaussJordanAlgorithmWithParalelization(Matrix& A, Vector& x, Vector& b)
{
	float alfa;
	int i = 0, j = 0, k = 0;
	int n = A.GetNumOfRows() - 1;					// -1, because indexing starts from 0
...
double GaussJordan::GaussJordanAlgorithmWithVectorization(Matrix& A, Vector& x, Vector& b)
{
	float alfa;
	int i = 0, j = 0, k = 0;
	int n = A.GetNumOfRows() - 1;					// -1, because indexing starts from 0
...
void GaussJordan::PrintResults(Vector& x)
{
	printf("\nResults:\n");
